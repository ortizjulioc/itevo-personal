         ...
         <div className="grid grid-cols-2 gap-2 mb-4">
            {[
              ...
              <Button
                key={p.value}
                type="button"
                variant={formData.period === p.value ? "default" : "outline"}
                className={index === 0 ? "ltr:rounded-l-md rtl:rounded-r-md" : "ltr:rounded-r-md rtl:rounded-l-md"}
                onClick={() => handleChange("period", p.value)}
              >
                {p.label}
              </Button>
            ))}
