...
export default function Attendance({ searchParams }: { searchParams?: { search?: string; page?: string } }) {
            ...
            <ViewTitle
                ...
                rightComponent={
                    <div className='flex gap-2'>
                        ...
                        <Button icon={<IconPlusCircle />} onClick={() => setOpenModal(true)}>Registrar Asistencia</Button>
