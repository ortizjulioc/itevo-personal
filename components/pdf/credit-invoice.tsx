...
export const CreditInvoicePDF = ({ invoice, companyInfo, logo }: { invoice: any, companyInfo: any, logo: Blob | null }) => {
  const { invoiceNumber, student, date, subtotal, itbis, items, user, comment } = invoice;
    ...
    <Document>
      <Page size={'A4'} style={styles.page}>
        <View style={styles.container}>
          ...
          <Text style={{ marginTop: 8,  }}>Firma: ____________________</Text>
