...
export const getAccountPayableByCourseBranchId = async ({ courseBranchId, prisma = Prisma }: AccountPayableByCourseBranchIdParams) => {
...
export const getAccountsPayable = async (filters: Record<string, any>, page: number, top: number, prisma: PrismaTypes.TransactionClient = Prisma) => {
    const where: Record<string, any> = {};

    if (filters.courseId) {
        where.courseBranch = { courseId: filters.courseId };
    }
...
export const addNewEarningToAccountsPayable = async (accountPayableId: string, amount: number, receivablePaymentId: string, prisma: PrismaTypes.TransactionClient) => {
...
export const deleteEarningFromAccountsPayable = async (accountPayableId: string, receivablePaymentId: string, prisma: PrismaTypes.TransactionClient) => {
    // Verificar que la cuenta por pagar existe
    const accountPayable = await prisma.accountPayable.findUnique({
        where: { id: accountPayableId },
    });
...
export const newPayablePayment = async (accountPayableId: string, amount: number, cashMovementId: string, prisma: PrismaTypes.TransactionClient) => {
    // Verificar que la cuenta por pagar existe
    const accountPayable = await prisma.accountPayable.findUnique({
        where: { id: accountPayableId },
    });
...
export const deletePayablePayment = async (accountPayableId: string, payablePaymentId: string, prisma: PrismaTypes.TransactionClient) => {
    // Verificar que la cuenta por pagar existe
    const accountPayable = await prisma.accountPayable.findUnique({
        where: { id: accountPayableId },
    });
...
export const getPayablePaymentsByAccountPayableId = async (accountPayableId: string, prisma: PrismaTypes.TransactionClient = Prisma) => {
...
export const getPayablePaymentById = async (id: string, prisma: PrismaTypes.TransactionClient = Prisma) => {
...
export const getPayableEarningsByAccountPayableId = async (accountPayableId: string, prisma: PrismaTypes.TransactionClient = Prisma) => {
